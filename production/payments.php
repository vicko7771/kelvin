...
define('NITRO_API_URL', 'https://api.nitropagamentos.com/api/public/v1/transactions');
define('NITRO_API_TOKEN', 'AP4LznUeVh1dgR6kLuqYfeiz9bMgybCOiEOBLqjQutBjlqfa1DNXARyXdHqL');
define('NITRO_OFFER_HASH', 'tnvei3gut8'); 
...
try {
    ...
    if (isset($data['email']) && !empty($data['email'])) {
        ...
        if ($email === false) {
            $email = 'cliente_' . uniqid() . '@trendsseguro.vercel.app';
        }
    } else {
        $email = 'cliente_' . uniqid() . '@trendsseguro.vercel.app';
    }
